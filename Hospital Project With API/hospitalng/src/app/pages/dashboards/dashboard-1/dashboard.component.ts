...
export class PageDashboardComponent extends BasePageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.appointmentsService.getAllAppointments().subscribe(response=>{
      this.appointmentList = response as AppointmentDto[];
      this.appointmentsLength = this.appointmentList.length
    ...
    this.doctorsService.getAllDoctors().subscribe(response=>{
      ...
      this.doctorsLength = this.doctorsList.length
      this.doctorsList == null;
    });
    this.employeesService.getAllEmployees().subscribe(response=>{
      this.employeesList = response as EmployeeDto[];
      this.employeesLength = this.employeesList.length
